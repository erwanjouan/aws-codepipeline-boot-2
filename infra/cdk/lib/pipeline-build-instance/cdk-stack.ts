...
export class PipelineBuildInstanceStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props?: CustomStackProps) {
    ...
    const codeartifact = new CodeArtifact(this, 'codeartifact', deploymentName)

    const codeCommit = new CodeCommit(this, 'codeCommitRepo')

    const codeBuildRole = new CodeBuildRole(this, 'codeBuildRole')

    const codeBuildApp = new CodeBuildApp(this, 'codeBuildApp', deploymentName, projectDeploymentName, artifactBucket, codeartifact, codeBuildRole)
