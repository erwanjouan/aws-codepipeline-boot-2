...
@Controller
@Profile(PR_ECS_FARGATE_PROFILE)
public class PrEcsFargateController extends AbstractBlueGreenController {
    ...
    public PrEcsFargateController() {
    }

    @GetMapping("/" + PR_ECS_FARGATE_PROFILE)
