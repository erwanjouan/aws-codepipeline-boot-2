...
@Controller
@Profile(ALB_ECS_EC2_PROFILE)
public class AlbEcsEc2Controller extends AbstractBlueGreenController {
    ...
    public AlbEcsEc2Controller() {
    }

    @GetMapping("/" + ALB_ECS_EC2_PROFILE)
