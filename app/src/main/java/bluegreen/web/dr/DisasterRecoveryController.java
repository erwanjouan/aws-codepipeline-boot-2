...
public class DisasterRecoveryController extends AbstractBlueGreenController {
    ...
    @GetMapping("/" + DISASTER_RECOVERY_PROFILE)
    public String drPage(final Model model) {
        ...
        return DISASTER_RECOVERY_PROFILE;
    }
}
